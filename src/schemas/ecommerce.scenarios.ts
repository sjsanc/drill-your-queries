...
export const ecommerceScenarios: Scenario[] = [
  ...
  },
  {
    ...
    concepts: ["select-basic"],
    difficulty: 1,
    expectedSql: "SELECT id AS order_id, status AS order_status FROM orders",
  },
  ...
  },
  {
    ...
    concepts: ["filter-equality"],
    difficulty: 1,
    expectedSql: "SELECT id, customer_id, created_at FROM orders WHERE status = 'delivered'",
  },
  {
    ...
    concepts: ["filter-equality"],
    difficulty: 1,
    expectedSql: "SELECT name, contact_email FROM suppliers WHERE country = 'DE'",
  },
  {
  ...
  },
  {
    ...
    concepts: ["filter-comparison"],
    difficulty: 1,
    expectedSql: "SELECT name, loyalty_points FROM customers WHERE loyalty_points > 1000",
  },
  {
    ...
    concepts: ["filter-comparison"],
    difficulty: 1,
    expectedSql: "SELECT id, product_id, rating FROM reviews WHERE rating < 3",
  },
  {
    ...
    concepts: ["filter-comparison"],
    difficulty: 1,
    expectedSql: "SELECT order_id, product_id, quantity FROM order_items WHERE quantity > 1",
  },
  ...
  // ── filter-logical ──────────────────────────────────────────────────────────
  {
    ...
    difficulty: 1,
    expectedSql: "SELECT name, price FROM products WHERE is_active = 1 AND price < 100",
  },
  {
    ...
    concepts: ["filter-logical"],
    difficulty: 1,
    expectedSql: "SELECT name, country FROM customers WHERE country = 'US' OR country = 'UK'",
  },
  {
    ...
    concepts: ["filter-logical"],
    difficulty: 1,
    expectedSql: "SELECT id, status, created_at FROM orders WHERE NOT status = 'cancelled'",
  },
  {
    ...
    concepts: ["filter-logical"],
    difficulty: 1,
    expectedSql: "SELECT name, category_id, price FROM products WHERE category_id = 4 OR price > 1000",
  },
  {
    ...
    concepts: ["filter-logical"],
    difficulty: 1,
    expectedSql: "SELECT name, tier, loyalty_points FROM customers WHERE tier = 'silver' AND loyalty_points < 700",
  },
  ...
  },
  {
    ...
    concepts: ["filter-null"],
    difficulty: 1,
    expectedSql: "SELECT id, name, parent_id FROM categories WHERE parent_id IS NOT NULL",
  },
  {
    ...
    concepts: ["filter-null"],
    difficulty: 1,
    expectedSql: "SELECT name, weight FROM products WHERE weight IS NOT NULL",
  },
  ...
  },
  {
    ...
    concepts: ["filter-like"],
    difficulty: 1,
    expectedSql: "SELECT name, country FROM suppliers WHERE name LIKE '% Ltd'",
  },
  {
  ...
  // ── filter-in ───────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["filter-in"],
    difficulty: 1,
    expectedSql: "SELECT id, customer_id, status FROM orders WHERE status IN ('shipped', 'pending')",
  },
  {
    id: "ecom-filter-in-2",
    ...
    concepts: ["filter-in"],
    difficulty: 1,
    expectedSql: "SELECT name, category_id, price FROM products WHERE category_id IN (2, 3)",
  },
  {
    id: "ecom-filter-in-3",
    ...
    concepts: ["filter-in"],
    difficulty: 1,
    expectedSql: "SELECT name, country FROM customers WHERE country NOT IN ('US', 'UK', 'CA', 'AU')",
  },
  {
    id: "ecom-filter-in-4",
    ...
    concepts: ["filter-in"],
    difficulty: 1,
    expectedSql: "SELECT customer_id, product_id, rating FROM reviews WHERE product_id IN (1, 4, 7)",
  },
  ...
  // ── filter-between ──────────────────────────────────────────────────────────
  {
    ...
    difficulty: 1,
    expectedSql: "SELECT name, price FROM products WHERE price BETWEEN 100 AND 1000",
  },
  {
    ...
    concepts: ["filter-between"],
    difficulty: 1,
    expectedSql: "SELECT id, customer_id, status, created_at FROM orders WHERE created_at BETWEEN '2024-02-01' AND '2024-02-28'",
  },
  {
    ...
    concepts: ["filter-between"],
    difficulty: 1,
    expectedSql: "SELECT name, loyalty_points FROM customers WHERE loyalty_points BETWEEN 500 AND 1500",
  },
  {
    ...
    concepts: ["filter-between"],
    difficulty: 1,
    expectedSql: "SELECT customer_id, product_id, rating FROM reviews WHERE rating BETWEEN 3 AND 4",
  },
  ...
  },
  {
    ...
    concepts: ["sort"],
    difficulty: 1,
    expectedSql: "SELECT name, loyalty_points FROM customers ORDER BY loyalty_points DESC, name ASC",
  },
  {
    id: "ecom-sort-3",
    ...
    concepts: ["sort"],
    difficulty: 1,
    expectedSql: "SELECT product_id, rating, created_at FROM reviews ORDER BY rating ASC, created_at DESC",
  },
  {
    id: "ecom-sort-4",
    ...
    concepts: ["sort"],
    difficulty: 1,
    expectedSql: "SELECT order_id, product_id, quantity, unit_price FROM order_items ORDER BY quantity DESC, unit_price DESC",
  },
  {
    id: "ecom-sort-5",
    ...
    concepts: ["sort"],
    difficulty: 1,
    expectedSql: "SELECT name, country FROM suppliers ORDER BY country ASC, name ASC",
  },
  ...
  // ── pagination ──────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["pagination"],
    difficulty: 1,
    expectedSql: "SELECT name, price FROM products ORDER BY price DESC LIMIT 5",
  },
  {
    ...
    concepts: ["pagination"],
    difficulty: 1,
    expectedSql: "SELECT name, joined_at FROM customers ORDER BY joined_at ASC LIMIT 3 OFFSET 2",
  },
  {
    ...
    concepts: ["pagination"],
    difficulty: 1,
    expectedSql: "SELECT id, customer_id, status, created_at FROM orders ORDER BY created_at DESC LIMIT 10",
  },
  {
    ...
    concepts: ["pagination"],
    difficulty: 1,
    expectedSql: "SELECT name FROM products ORDER BY name ASC LIMIT 5 OFFSET 5",
  },
  ...
  },
  {
    ...
    concepts: ["aggregate-basic"],
    difficulty: 1,
    expectedSql: "SELECT COUNT(*) AS delivered_orders FROM orders WHERE status = 'delivered'",
  },
  {
    ...
    concepts: ["aggregate-basic"],
    difficulty: 1,
    expectedSql: "SELECT SUM(quantity * unit_price) AS total_revenue FROM order_items",
  },
  {
  ...
  },
  {
    ...
    concepts: ["aggregate-basic"],
    difficulty: 1,
    expectedSql: "SELECT MAX(price) AS max_price, MIN(price) AS min_price FROM products",
  },
  {
    ...
    concepts: ["aggregate-basic"],
    difficulty: 1,
    expectedSql: "SELECT SUM(stock) AS total_stock FROM products WHERE is_active = 1",
  },
  ...
  // ── aggregate-distinct ──────────────────────────────────────────────────────
  {
    ...
    difficulty: 1,
    expectedSql: "SELECT COUNT(DISTINCT country) AS country_count FROM customers",
  },
  {
    ...
    concepts: ["aggregate-distinct"],
    difficulty: 1,
    expectedSql: "SELECT COUNT(DISTINCT product_id) AS reviewed_products FROM reviews",
  },
  {
    ...
    concepts: ["aggregate-distinct"],
    difficulty: 1,
    expectedSql: "SELECT COUNT(DISTINCT customer_id) AS active_customers FROM orders",
  },
  ...
  // ── group-by ────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["group-by"],
    difficulty: 1,
    expectedSql: "SELECT category_id, COUNT(*) AS product_count FROM products GROUP BY category_id",
  },
  {
    id: "ecom-group-by-2",
    ...
    concepts: ["group-by"],
    difficulty: 1,
    expectedSql: "SELECT customer_id, COUNT(*) AS order_count FROM orders GROUP BY customer_id",
  },
  {
    id: "ecom-group-by-3",
    ...
    concepts: ["group-by"],
    difficulty: 1,
    expectedSql: "SELECT country, COUNT(*) AS customer_count FROM customers GROUP BY country",
  },
  {
    id: "ecom-group-by-4",
    ...
    concepts: ["group-by"],
    difficulty: 1,
    expectedSql: "SELECT order_id, SUM(quantity * unit_price) AS order_total FROM order_items GROUP BY order_id",
  },
  {
    id: "ecom-group-by-5",
    ...
    concepts: ["group-by"],
    difficulty: 1,
    expectedSql: "SELECT product_id, AVG(rating) AS avg_rating FROM reviews GROUP BY product_id",
  },
  {
    id: "ecom-group-by-6",
  ...
  },
  {
    ...
    concepts: ["group-by"],
    difficulty: 1,
    expectedSql: "SELECT category_id, SUM(stock) AS total_stock FROM products GROUP BY category_id",
  },
  ...
  // ── having ──────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["having"],
    difficulty: 2,
    expectedSql: "SELECT category_id, COUNT(*) AS product_count FROM products GROUP BY category_id HAVING COUNT(*) > 2",
  },
  {
    id: "ecom-having-2",
    ...
    concepts: ["having"],
    difficulty: 2,
    expectedSql: "SELECT customer_id, COUNT(*) AS order_count FROM orders GROUP BY customer_id HAVING COUNT(*) > 2",
  },
  {
    id: "ecom-having-3",
    ...
    concepts: ["having"],
    difficulty: 2,
    expectedSql: "SELECT product_id, AVG(rating) AS avg_rating FROM reviews GROUP BY product_id HAVING AVG(rating) >= 4",
  },
  {
    id: "ecom-having-4",
    ...
    concepts: ["having"],
    difficulty: 2,
    expectedSql: "SELECT country, COUNT(*) AS customer_count FROM customers GROUP BY country HAVING COUNT(*) > 2",
  },
  {
    id: "ecom-having-5",
    ...
    concepts: ["having"],
    difficulty: 2,
    expectedSql: "SELECT order_id, COUNT(*) AS item_count FROM order_items GROUP BY order_id HAVING COUNT(*) > 1",
  },
  ...
  // ── join-inner ──────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["join-inner"],
    difficulty: 1,
    expectedSql: "SELECT p.name AS product, c.name AS category FROM products p JOIN categories c ON p.category_id = c.id",
  },
  {
    ...
    concepts: ["join-inner"],
    difficulty: 1,
    expectedSql: "SELECT o.id, c.name AS customer, o.status, o.created_at FROM orders o JOIN customers c ON o.customer_id = c.id",
  },
  {
    ...
    concepts: ["join-inner"],
    difficulty: 1,
    expectedSql: "SELECT r.customer_id, p.name AS product, r.rating FROM reviews r JOIN products p ON r.product_id = p.id",
  },
  {
    ...
    concepts: ["join-inner"],
    difficulty: 1,
    expectedSql: "SELECT oi.order_id, p.name AS product, oi.quantity, oi.unit_price FROM order_items oi JOIN products p ON oi.product_id = p.id",
  },
  {
    ...
    concepts: ["join-inner"],
    difficulty: 1,
    expectedSql: "SELECT c.name AS reviewer, r.product_id, r.rating, r.body FROM reviews r JOIN customers c ON r.customer_id = c.id",
  },
  ...
  // ── join-left ───────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["join-left"],
    difficulty: 2,
    expectedSql: "SELECT c.name, COUNT(o.id) AS order_count FROM customers c LEFT JOIN orders o ON o.customer_id = c.id GROUP BY c.id, c.name",
  },
  {
    id: "ecom-join-left-2",
    ...
    concepts: ["join-left"],
    difficulty: 2,
    expectedSql: "SELECT p.name, COUNT(r.id) AS review_count FROM products p LEFT JOIN reviews r ON r.product_id = p.id GROUP BY p.id, p.name",
  },
  {
    id: "ecom-join-left-3",
    ...
    concepts: ["join-left"],
    difficulty: 2,
    expectedSql: "SELECT c.name, MAX(o.created_at) AS last_order FROM customers c LEFT JOIN orders o ON o.customer_id = c.id GROUP BY c.id, c.name",
  },
  {
    id: "ecom-join-left-4",
    ...
    concepts: ["join-left"],
    difficulty: 2,
    expectedSql: "SELECT p.name, COALESCE(SUM(oi.quantity), 0) AS total_sold FROM products p LEFT JOIN order_items oi ON oi.product_id = p.id GROUP BY p.id, p.name",
  },
  {
    id: "ecom-join-left-5",
    ...
    concepts: ["join-left"],
    difficulty: 2,
    expectedSql: "SELECT c.name, COUNT(p.id) AS product_count FROM categories c LEFT JOIN products p ON p.category_id = c.id GROUP BY c.id, c.name",
  },
  ...
  // ── join-multi ──────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["join-multi"],
    difficulty: 2,
    expectedSql: "SELECT c.name AS reviewer, p.name AS product, r.rating FROM reviews r JOIN customers c ON r.customer_id = c.id JOIN products p ON r.product_id = p.id",
  },
  {
    ...
    concepts: ["join-multi"],
    difficulty: 2,
    expectedSql: "SELECT c.name AS customer, o.id AS order_id, SUM(oi.quantity * oi.unit_price) AS order_total FROM orders o JOIN customers c ON o.customer_id = c.id JOIN order_items oi ON oi.order_id = o.id GROUP BY o.id, c.name",
  },
  {
    ...
    concepts: ["join-multi"],
    difficulty: 2,
    expectedSql: "SELECT p.name AS product, c.name AS category, MIN(ps.cost_price) AS min_cost FROM products p JOIN categories c ON p.category_id = c.id JOIN product_suppliers ps ON ps.product_id = p.id GROUP BY p.id, p.name, c.name",
  },
  {
    ...
    concepts: ["join-multi"],
    difficulty: 2,
    expectedSql: "SELECT c.name AS customer, p.name AS product, oi.quantity, oi.quantity * oi.unit_price AS subtotal FROM order_items oi JOIN orders o ON oi.order_id = o.id JOIN customers c ON o.customer_id = c.id JOIN products p ON oi.product_id = p.id",
  },
  {
    ...
    concepts: ["join-multi"],
    difficulty: 2,
    expectedSql: "SELECT p.name AS product, c.name AS category, s.name AS supplier FROM products p JOIN categories c ON p.category_id = c.id JOIN product_suppliers ps ON ps.product_id = p.id JOIN suppliers s ON ps.supplier_id = s.id",
  },
  ...
  // ── join-self ───────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["join-self"],
    difficulty: 2,
    expectedSql: "SELECT child.name AS subcategory, parent.name AS parent_category FROM categories child JOIN categories parent ON child.parent_id = parent.id",
  },
  {
    id: "ecom-join-self-2",
    ...
    concepts: ["join-self"],
    difficulty: 2,
    expectedSql: "SELECT p1.name AS product1, p2.name AS product2, p1.category_id FROM products p1 JOIN products p2 ON p1.category_id = p2.category_id AND p1.id < p2.id",
  },
  {
    id: "ecom-join-self-3",
    ...
    concepts: ["join-self"],
    difficulty: 2,
    expectedSql: "SELECT a.name AS category1, b.name AS category2, a.parent_id FROM categories a JOIN categories b ON a.parent_id = b.parent_id AND a.id < b.id WHERE a.parent_id IS NOT NULL",
  },
  ...
  // ── join-cross ──────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["join-cross"],
    difficulty: 2,
    expectedSql: "SELECT s.name AS supplier, c.name AS category FROM suppliers s CROSS JOIN categories c WHERE c.parent_id IS NOT NULL",
  },
  {
    ...
    concepts: ["join-cross"],
    difficulty: 2,
    expectedSql: "SELECT t.tier, s.status FROM (SELECT DISTINCT tier FROM customers) t CROSS JOIN (SELECT DISTINCT status FROM orders) s",
  },
  ...
  // ── subquery-scalar ─────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name, price FROM products WHERE price > (SELECT AVG(price) FROM products)",
  },
  {
    ...
    concepts: ["subquery-scalar"],
    difficulty: 2,
    expectedSql: "SELECT name, loyalty_points FROM customers WHERE loyalty_points = (SELECT MAX(loyalty_points) FROM customers)",
  },
  {
    ...
    concepts: ["subquery-scalar"],
    difficulty: 2,
    expectedSql: "SELECT name, price, (SELECT AVG(price) FROM products) AS avg_price FROM products",
  },
  {
    ...
    concepts: ["subquery-scalar"],
    difficulty: 2,
    expectedSql: "SELECT id, status, created_at FROM orders WHERE customer_id = (SELECT id FROM customers ORDER BY loyalty_points DESC LIMIT 1)",
  },
  ...
  // ── subquery-in ─────────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name, email FROM customers WHERE id IN (SELECT DISTINCT customer_id FROM orders)",
  },
  {
    ...
    concepts: ["subquery-in"],
    difficulty: 2,
    expectedSql: "SELECT name, price FROM products WHERE id IN (SELECT DISTINCT product_id FROM reviews)",
  },
  {
    ...
    concepts: ["subquery-in"],
    difficulty: 2,
    expectedSql: "SELECT name, email FROM customers WHERE id NOT IN (SELECT DISTINCT customer_id FROM orders)",
  },
  {
    ...
    concepts: ["subquery-in"],
    difficulty: 2,
    expectedSql: "SELECT DISTINCT o.id, o.status FROM orders o WHERE o.id IN (SELECT oi.order_id FROM order_items oi JOIN products p ON oi.product_id = p.id WHERE p.category_id = 3)",
  },
  ...
  // ── subquery-correlated ─────────────────────────────────────────────────────
  {
    ...
    difficulty: 3,
    expectedSql: "SELECT name, category_id, price FROM products p WHERE price > (SELECT AVG(price) FROM products WHERE category_id = p.category_id)",
  },
  {
    ...
    concepts: ["subquery-correlated"],
    difficulty: 3,
    expectedSql: "SELECT name, tier, loyalty_points FROM customers c WHERE loyalty_points > (SELECT AVG(loyalty_points) FROM customers WHERE tier = c.tier)",
  },
  {
    ...
    concepts: ["subquery-correlated"],
    difficulty: 3,
    expectedSql: "SELECT name FROM customers c WHERE (SELECT COUNT(*) FROM orders WHERE customer_id = c.id) > (SELECT AVG(cnt) FROM (SELECT COUNT(*) AS cnt FROM orders GROUP BY customer_id))",
  },
  ...
  // ── subquery-derived ────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT order_id, order_total FROM (SELECT order_id, SUM(quantity * unit_price) AS order_total FROM order_items GROUP BY order_id) WHERE order_total > 500",
  },
  {
    ...
    concepts: ["subquery-derived"],
    difficulty: 2,
    expectedSql: "SELECT product_id, avg_rating FROM (SELECT product_id, AVG(rating) AS avg_rating FROM reviews GROUP BY product_id) WHERE avg_rating >= 4",
  },
  {
    ...
    concepts: ["subquery-derived"],
    difficulty: 3,
    expectedSql: "SELECT customer_id, total_spend FROM (SELECT o.customer_id, SUM(oi.quantity * oi.unit_price) AS total_spend FROM orders o JOIN order_items oi ON o.id = oi.order_id GROUP BY o.customer_id) WHERE total_spend > 1000",
  },
  ...
  // ── exists ──────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["exists"],
    difficulty: 2,
    expectedSql: "SELECT name, price FROM products p WHERE EXISTS (SELECT 1 FROM reviews r WHERE r.product_id = p.id)",
  },
  {
    id: "ecom-exists-2",
    ...
    concepts: ["exists"],
    difficulty: 2,
    expectedSql: "SELECT name, price FROM products p WHERE EXISTS (SELECT 1 FROM order_items oi JOIN orders o ON oi.order_id = o.id WHERE oi.product_id = p.id AND o.status = 'delivered')",
  },
  {
    id: "ecom-exists-3",
    ...
    concepts: ["exists"],
    difficulty: 2,
    expectedSql: "SELECT name, email FROM customers c WHERE EXISTS (SELECT 1 FROM orders o WHERE o.customer_id = c.id AND o.status = 'delivered')",
  },
  {
    id: "ecom-exists-4",
    ...
    concepts: ["exists"],
    difficulty: 2,
    expectedSql: "SELECT name, price FROM products p WHERE EXISTS (SELECT 1 FROM order_items oi JOIN orders o ON oi.order_id = o.id WHERE oi.product_id = p.id AND o.status = 'cancelled')",
  },
  ...
  // ── union ───────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["union"],
    difficulty: 2,
    expectedSql: "SELECT email FROM customers UNION SELECT contact_email AS email FROM suppliers",
  },
  {
    id: "ecom-union-2",
    ...
    concepts: ["union"],
    difficulty: 2,
    expectedSql: "SELECT country FROM customers UNION SELECT country FROM suppliers",
  },
  {
    id: "ecom-union-3",
    ...
    concepts: ["union"],
    difficulty: 2,
    expectedSql: "SELECT name FROM customers UNION SELECT name FROM suppliers",
  },
  ...
  // ── union-all ────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["union-all"],
    difficulty: 2,
    expectedSql: "SELECT product_id FROM order_items UNION ALL SELECT product_id FROM reviews",
  },
  {
    id: "ecom-union-all-2",
    ...
    concepts: ["union-all"],
    difficulty: 2,
    expectedSql: "SELECT customer_id FROM orders UNION ALL SELECT customer_id FROM reviews",
  },
  ...
  // ── intersect ────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["intersect"],
    difficulty: 2,
    expectedSql: "SELECT product_id FROM order_items INTERSECT SELECT product_id FROM reviews",
  },
  {
    id: "ecom-intersect-2",
    ...
    concepts: ["intersect"],
    difficulty: 2,
    expectedSql: "SELECT customer_id FROM orders INTERSECT SELECT customer_id FROM reviews",
  },
  ...
  // ── except ───────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["except"],
    difficulty: 2,
    expectedSql: "SELECT ps.supplier_id FROM product_suppliers ps JOIN products p ON ps.product_id = p.id WHERE p.category_id = 2 EXCEPT SELECT ps.supplier_id FROM product_suppliers ps JOIN products p ON ps.product_id = p.id WHERE p.category_id = 3",
  },
  {
    id: "ecom-except-2",
    ...
    concepts: ["except"],
    difficulty: 2,
    expectedSql: "SELECT product_id FROM order_items EXCEPT SELECT product_id FROM reviews",
  },
  {
    id: "ecom-except-3",
    ...
    concepts: ["except"],
    difficulty: 2,
    expectedSql: "SELECT customer_id FROM reviews EXCEPT SELECT customer_id FROM orders",
  },
  ...
  // ── case-simple ──────────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT id, CASE status WHEN 'delivered' THEN 'Delivered' WHEN 'shipped' THEN 'Shipped' WHEN 'pending' THEN 'Pending' WHEN 'cancelled' THEN 'Cancelled' END AS status_label FROM orders",
  },
  {
    ...
    concepts: ["case-simple"],
    difficulty: 2,
    expectedSql: "SELECT product_id, rating, CASE rating WHEN 5 THEN 'Excellent' WHEN 4 THEN 'Good' WHEN 3 THEN 'Average' WHEN 2 THEN 'Poor' WHEN 1 THEN 'Terrible' END AS rating_label FROM reviews",
  },
  {
    ...
    concepts: ["case-simple"],
    difficulty: 2,
    expectedSql: "SELECT name, tier, CASE tier WHEN 'bronze' THEN 1 WHEN 'silver' THEN 2 WHEN 'gold' THEN 3 END AS tier_rank FROM customers",
  },
  ...
  // ── case-searched ────────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name, price, CASE WHEN price < 50 THEN 'Budget' WHEN price <= 500 THEN 'Mid-range' ELSE 'Premium' END AS price_band FROM products",
  },
  {
    ...
    concepts: ["case-searched"],
    difficulty: 2,
    expectedSql: "SELECT name, loyalty_points, CASE WHEN loyalty_points >= 2000 THEN 'VIP' WHEN loyalty_points >= 1000 THEN 'Loyal' WHEN loyalty_points >= 500 THEN 'Regular' ELSE 'New' END AS customer_label FROM customers",
  },
  {
    ...
    concepts: ["case-searched"],
    difficulty: 2,
    expectedSql: "SELECT id, status, CASE WHEN status = 'delivered' THEN 'Completed' WHEN status = 'shipped' THEN 'In Transit' WHEN status = 'pending' THEN 'Awaiting' ELSE 'Cancelled' END AS progress FROM orders",
  },
  {
    ...
    concepts: ["case-searched"],
    difficulty: 2,
    expectedSql: "SELECT name, stock, CASE WHEN stock = 0 THEN 'Out of stock' WHEN stock < 30 THEN 'Low' WHEN stock <= 100 THEN 'Medium' ELSE 'High' END AS stock_level FROM products",
  },
  ...
  // ── coalesce ─────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["coalesce"],
    difficulty: 2,
    expectedSql: "SELECT name, COALESCE(CAST(parent_id AS TEXT), 'Top-level') AS parent FROM categories",
  },
  {
    id: "ecom-coalesce-2",
    ...
    concepts: ["coalesce"],
    difficulty: 2,
    expectedSql: "SELECT name, NULLIF(loyalty_points, 0) AS points FROM customers",
  },
  {
    id: "ecom-coalesce-3",
    ...
    concepts: ["coalesce"],
    difficulty: 2,
    expectedSql: "SELECT name, COALESCE(weight, 0.0) AS weight FROM products",
  },
  ...
  // ── cast ─────────────────────────────────────────────────────────────────────
  {
    ...
    concepts: ["cast"],
    difficulty: 2,
    expectedSql: "SELECT name, CAST(price AS INTEGER) AS price_int FROM products",
  },
  {
    id: "ecom-cast-2",
    ...
    concepts: ["cast"],
    difficulty: 2,
    expectedSql: "SELECT name, CAST(SUBSTR(joined_at, 1, 4) AS INTEGER) AS join_year FROM customers",
  },
  {
    id: "ecom-cast-3",
    ...
    concepts: ["cast"],
    difficulty: 2,
    expectedSql: "SELECT name, CAST(loyalty_points AS REAL) / 100.0 AS points_in_hundreds FROM customers",
  },
  ...
  },
  {
    ...
    concepts: ["string-basic"],
    difficulty: 1,
    expectedSql: "SELECT name, LENGTH(name) AS name_length FROM products ORDER BY name_length DESC",
  },
  {
  ...
  },
  {
    ...
    concepts: ["string-basic"],
    difficulty: 1,
    expectedSql: "SELECT name, LENGTH(email) AS email_length FROM customers ORDER BY email_length DESC",
  },
  ...
  // ── string-concat ─────────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name || ' <' || email || '>' AS formatted FROM customers",
  },
  {
    ...
    concepts: ["string-concat"],
    difficulty: 2,
    expectedSql: "SELECT name || ' ($' || CAST(price AS TEXT) || ')' AS product_label FROM products",
  },
  {
    ...
    concepts: ["string-concat"],
    difficulty: 2,
    expectedSql: "SELECT 'Order #' || CAST(id AS TEXT) || ' - ' || status AS order_label FROM orders",
  },
...
SELECT id, name FROM ancestors`,
  ...
  // ── window-row-number ─────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name, category_id, price, ROW_NUMBER() OVER (PARTITION BY category_id ORDER BY price DESC) AS rn FROM products",
  },
  {
    ...
    concepts: ["window-row-number"],
    difficulty: 2,
    expectedSql: "SELECT customer_id, created_at, ROW_NUMBER() OVER (PARTITION BY customer_id ORDER BY created_at ASC) AS order_num FROM orders",
  },
  {
    ...
    concepts: ["window-row-number"],
    difficulty: 2,
    expectedSql: "SELECT name, loyalty_points, ROW_NUMBER() OVER (ORDER BY loyalty_points DESC) AS rank FROM customers",
  },
  {
    ...
    concepts: ["window-row-number"],
    difficulty: 2,
    expectedSql: "SELECT product_id, rating, ROW_NUMBER() OVER (PARTITION BY product_id ORDER BY rating DESC) AS rn FROM reviews",
  },
  ...
  // ── window-rank ───────────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name, category_id, price, RANK() OVER (PARTITION BY category_id ORDER BY price DESC) AS price_rank FROM products",
  },
  {
    ...
    concepts: ["window-rank"],
    difficulty: 2,
    expectedSql: "SELECT name, loyalty_points, RANK() OVER (ORDER BY loyalty_points DESC) AS rank FROM customers",
  },
  {
    ...
    concepts: ["window-rank"],
    difficulty: 2,
    expectedSql: "SELECT name, price, DENSE_RANK() OVER (ORDER BY price DESC) AS dense_rank FROM products",
  },
  {
    ...
    concepts: ["window-rank"],
    difficulty: 3,
    expectedSql: "SELECT order_id, SUM(quantity * unit_price) AS order_total, RANK() OVER (ORDER BY SUM(quantity * unit_price) DESC) AS value_rank FROM order_items GROUP BY order_id",
  },
  ...
  // ── window-ntile ──────────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name, price, NTILE(4) OVER (ORDER BY price ASC) AS quartile FROM products",
  },
  {
    ...
    concepts: ["window-ntile"],
    difficulty: 2,
    expectedSql: "SELECT name, loyalty_points, NTILE(3) OVER (ORDER BY loyalty_points DESC) AS group_num FROM customers",
  },
  {
    ...
    concepts: ["window-ntile"],
    difficulty: 2,
    expectedSql: "SELECT order_id, product_id, unit_price, NTILE(2) OVER (ORDER BY unit_price DESC) AS half FROM order_items",
  },
  ...
  // ── window-lag-lead ───────────────────────────────────────────────────────────
  {
    ...
    difficulty: 3,
    expectedSql: "SELECT customer_id, created_at, LAG(created_at) OVER (PARTITION BY customer_id ORDER BY created_at) AS prev_order FROM orders",
  },
  {
    ...
    concepts: ["window-lag-lead"],
    difficulty: 3,
    expectedSql: "SELECT customer_id, created_at, LEAD(created_at) OVER (PARTITION BY customer_id ORDER BY created_at) AS next_order FROM orders",
  },
  {
    ...
    concepts: ["window-lag-lead"],
    difficulty: 3,
    expectedSql: "SELECT product_id, created_at, rating, LAG(rating) OVER (PARTITION BY product_id ORDER BY created_at) AS prev_rating FROM reviews",
  },
  ...
  // ── window-running-total ──────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name, price, SUM(price) OVER (ORDER BY price ASC ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) AS running_total FROM products ORDER BY price ASC",
  },
  {
    ...
    concepts: ["window-running-total"],
    difficulty: 3,
    expectedSql: "SELECT name, tier, loyalty_points, SUM(loyalty_points) OVER (PARTITION BY tier ORDER BY id ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) AS running_total FROM customers",
  },
  {
    ...
    concepts: ["window-running-total"],
    difficulty: 3,
    expectedSql: "SELECT customer_id, created_at, COUNT(*) OVER (PARTITION BY customer_id ORDER BY created_at ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) AS running_count FROM orders",
  },
  ...
  // ── window-partition ──────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT name, category_id, price, AVG(price) OVER (PARTITION BY category_id) AS category_avg FROM products",
  },
  {
    ...
    concepts: ["window-partition"],
    difficulty: 2,
    expectedSql: "SELECT name, tier, loyalty_points, MAX(loyalty_points) OVER (PARTITION BY tier) AS tier_max FROM customers",
  },
  {
    ...
    concepts: ["window-partition"],
    difficulty: 2,
    expectedSql: "SELECT customer_id, product_id, rating, AVG(rating) OVER (PARTITION BY product_id) AS product_avg_rating FROM reviews",
  },
  {
    ...
    concepts: ["window-partition"],
    difficulty: 2,
    expectedSql: "SELECT id, status, COUNT(*) OVER (PARTITION BY status) AS status_count FROM orders",
  },
  ...
  },
  {
    ...
    concepts: ["window-frame"],
    difficulty: 3,
    expectedSql: "SELECT product_id, created_at, rating, AVG(rating) OVER (PARTITION BY product_id ORDER BY created_at ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS rolling_avg FROM reviews",
  },
  {
    ...
    concepts: ["window-frame"],
    difficulty: 3,
    expectedSql: "SELECT id, created_at, COUNT(*) OVER (ORDER BY created_at ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS rolling_count FROM orders",
  },
  ...
  // ── window-first-last ─────────────────────────────────────────────────────────
  {
    ...
    difficulty: 3,
    expectedSql: "SELECT name, category_id, price, FIRST_VALUE(price) OVER (PARTITION BY category_id ORDER BY price ASC) AS cheapest_in_category FROM products",
  },
  {
    ...
    concepts: ["window-first-last"],
    difficulty: 3,
    expectedSql: "SELECT product_id, created_at, rating, FIRST_VALUE(created_at) OVER (PARTITION BY product_id ORDER BY created_at ASC) AS first_reviewed FROM reviews",
  },
  {
    ...
    concepts: ["window-first-last"],
    difficulty: 3,
    expectedSql: "SELECT customer_id, id, created_at, LAST_VALUE(created_at) OVER (PARTITION BY customer_id ORDER BY created_at ASC ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) AS latest_order FROM orders",
  },
  ...
  // ── sqlite-strftime ───────────────────────────────────────────────────────────
  {
    ...
    difficulty: 1,
    expectedSql: "SELECT name, strftime('%Y', joined_at) AS join_year FROM customers",
  },
  {
    ...
    concepts: ["sqlite-strftime"],
    difficulty: 2,
    expectedSql: "SELECT strftime('%Y-%m', created_at) AS month, COUNT(*) AS order_count FROM orders GROUP BY strftime('%Y-%m', created_at)",
  },
  {
    ...
    concepts: ["sqlite-strftime"],
    difficulty: 2,
    expectedSql: "SELECT name, joined_at FROM customers WHERE strftime('%Y', joined_at) < '2023'",
  },
  {
    ...
    concepts: ["sqlite-strftime"],
    difficulty: 2,
    expectedSql: "SELECT strftime('%Y-%m', created_at) AS month, COUNT(*) AS review_count FROM reviews GROUP BY strftime('%Y-%m', created_at)",
  },
  ...
  // ── sqlite-json ───────────────────────────────────────────────────────────────
  {
    ...
    difficulty: 2,
    expectedSql: "SELECT json_object('id', id, 'name', name, 'price', price) AS product_json FROM products",
  },
  {
  ...
  },
  {
    ...
    concepts: ["sqlite-json"],
    difficulty: 3,
    expectedSql: "SELECT json_extract(json_object('name', name, 'stock', stock), '$.stock') AS extracted_stock FROM products",
  },
];
